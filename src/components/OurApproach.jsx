    ...
    <section className="relative w-full h-screen bg-black text-white py-10 px-6 md:px-20 lg:px-32 z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-y-5 gap-x-5 max-w-5xl">
        ...
        <div>
          ...
          <p className="mt-4 text-gray-300 text-sm leading-relaxed w-80">
            Beyond financial return, we aim to deliver societal value —
            through employment, community engagement and responsible
            business practices.
          </p>
        ...
        <div>
          ...
          <p className="mt-4 text-gray-300 text-sm leading-relaxed w-80">
            Through shared best practices, rigorous governance and 
            scalability focus, we help our companies punch above their size.
          </p>
